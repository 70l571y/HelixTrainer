...
База данных хранится в файле `hxtrainer.db`, а каталог `challenges_data` будет автоматически создан при первом запуске установленного бинарника. Вы можете очистить прогресс, удалив этот каталог.
